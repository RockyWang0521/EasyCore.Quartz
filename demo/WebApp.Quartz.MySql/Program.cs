...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        var connectionString = builder.Configuration.GetConnectionString("Quartz")
            ?? throw new InvalidOperationException("ConnectionStrings:Quartz is required for the MySQL demo.");
        ...
        builder.Services.AddEasyCoreQuartz(options =>
        {
            ...
            options.UseMySql(mysql => mysql.ConnectionString = connectionString);
